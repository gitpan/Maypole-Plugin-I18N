# This Makefile is for the Maypole::Plugin::I18N extension to perl.
#
...
#     NAME => q[Maypole::Plugin::I18N]
#     PREREQ_PM => { Locale::Maketext::Simple=>q[0], Maypole=>q[2.0] }
#     VERSION_FROM => q[I18N.pm]
...
PM_TO_BLIB = I18N.pm \
	$(INST_LIB)/Maypole/Plugin/I18N.pm
...
DISTNAME = Maypole-Plugin-I18N
DISTVNAME = Maypole-Plugin-I18N-0.01
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3pm --perm_rw=$(PERM_RW)\
	  I18N.pm $(INST_MAN3DIR)/Maypole::Plugin::I18N.$(MAN3EXT) 
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  $(MAKEFILE_OLD) $(FIRST_MAKEFILE) $(INST_LIB)/Maypole/Plugin/I18N.pm
...
metafile :
	...
	$(NOECHO) $(ECHO) 'name:         Maypole-Plugin-I18N' >> META.yml
	$(NOECHO) $(ECHO) 'version:      0.01' >> META.yml
	$(NOECHO) $(ECHO) 'version_from: I18N.pm' >> META.yml
	$(NOECHO) $(ECHO) 'installdirs:  site' >> META.yml
	$(NOECHO) $(ECHO) 'requires:' >> META.yml
	$(NOECHO) $(ECHO) '    Locale::Maketext::Simple:      0' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Locale-Maketext-Simple" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
...
pm_to_blib: $(TO_INST_PM)
	$(NOECHO) $(PERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', '\''$(PM_FILTER)'\'')'\
	  I18N.pm $(INST_LIB)/Maypole/Plugin/I18N.pm 
	$(NOECHO) $(TOUCH) $@
